      ...
      <div className="space-y-4">
        ...
        <div>
            ...
            <input 
                ...
                className="block w-full text-sm text-slate-500 theme-file-input"
            />
        </div>
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <button 
            ...
            className="px-4 py-2 theme-bg-primary text-white rounded-md theme-bg-primary-hover disabled:bg-slate-400 dark:disabled:bg-slate-600 disabled:cursor-not-allowed"
          >
